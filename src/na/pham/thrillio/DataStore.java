...
//		bookmarks[2][0] = BookmarkManager.getInstance().createBook(4001, "Walden", 1854, "Wilder Publications",
//				new String[] { "Henry David Thoreau" }, BookGenre.PHILOSOPHY, 4.3);
//		bookmarks[2][1] = BookmarkManager.getInstance().createBook(4002, "Self-Reliance and Other Essays", 1993,
//				"Dover Publications", new String[] { "Ralph Waldo Emerson" }, BookGenre.PHILOSOPHY, 4.5);
//		bookmarks[2][2] = BookmarkManager.getInstance().createBook(4003, "Light From Many Lamps", 1988, "Touchstone",
//				new String[] { "Lillian Eichler Watson" }, BookGenre.PHILOSOPHY, 5.0);
//		bookmarks[2][3] = BookmarkManager.getInstance().createBook(4004, "Head First Design Patterns", 2004,
...
//				2007, "Prentice Hall", new String[] { "Joshua Bloch" }, BookGenre.TECHNICAL, 4.9);
		...
		for (String row : data) {
			...
			bookmarks[2][rowNum++] = BookmarkManager.getInstance().createBook(Long.parseLong(values[0]), values[1], Integer.parseInt(values[2]), values[3], authors, BookGenre.valueOf(values[5]), Double.parseDouble(values[6]));
...
//				new String[] { "Joseph Cotten", "Orson Welles" }, new String[] { "Orson Welles" }, MovieGenre.CLASSICS,
//				8.5);
//		bookmarks[1][1] = BookmarkManager.getInstance().createMovie(3001, "The Grapes of Wrath	1940", "", 1940,
...
//		users[1] = UserManager.getInstance().createUser(1001, "user10@semanticsquare.com", "test", "Sam", "M",
//				Gender.MALE, UserType.USER);
//		users[2] = UserManager.getInstance().createUser(1002, "user2@semanticsquare.com", "test", "Anita", "M",
//				Gender.FEMALE, UserType.EDITOR);
//		users[3] = UserManager.getInstance().createUser(1003, "user30@semanticsquare.com", "test", "Sara", "M",
//				Gender.FEMALE, UserType.EDITOR);
//		users[4] = UserManager.getInstance().createUser(1004, "user40@semanticsquare.com", "test", "Dehh", "M",
...
//		bookmarks[0][0] = BookmarkManager.getInstance().createWebLink(2000, "Tiger, Part 2",
